...
export function Results({userName}) {
    ...
    React.useEffect( () => {
        ...
        if (meal === "Breakfast") {
            ...
            mealId = json.meals[Math.floor(Math.random() * json.meals.length)].idMeal;
            ...
            let categories = ["Beef", "Chicken", "Seafood", "Pasta", "Pork", "Lamb"]
        ...
        setImgUrl(mealData.meals[0].strMealThumb);
        setRecipeName(mealData.meals[0].strMeal);
        setInstructions(mealData.meals[0].strInstructions);
    }
    getRecipe();
    }, []);
